...
func (es *ExecutionStats) GetStats() ExecutionStats {
	...
	return ExecutionStats{
		...
		QueueFullEvents:     es.QueueFullEvents,
		TasksPerSecond:      es.TasksPerSecond,
		AverageTaskDuration: es.AverageTaskDuration,
		LastError:           es.LastError,
		ErrorCount:          es.ErrorCount,
		PotentialDeadlocks:  es.PotentialDeadlocks,
		TimeoutEvents:       es.TimeoutEvents,
		ScaleUpEvents:       es.ScaleUpEvents,
		ScaleDownEvents:     es.ScaleDownEvents,
