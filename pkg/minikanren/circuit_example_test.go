...
// ExampleNewCircuit demonstrates constructing a Circuit constraint for a small
// instance. We show that self-loops are removed and the ordering variable at
// the start node is fixed to 1 via propagation.
