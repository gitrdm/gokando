...
// ExampleNewRegular demonstrates the Regular global constraint with a DFA
// that accepts exactly those sequences ending with symbol 1 over alphabet {1,2}.
//
// With three variables x1,x2,x3 initially in {1,2}, propagation prunes x3 to {1}.
